          ...
          {features.map((feature, index) => (
            ...
            >
              <CardContent className="text-center h-full flex flex-col">
                ...
                <p className="text-charcoal-500 leading-relaxed mb-4 flex-grow">
                  {feature.description}
                </p>
                
                <div className="mt-auto">
                  <span className="inline-block px-4 py-2 bg-accent-50 text-accent-600 rounded-full text-sm font-medium">
                    {feature.highlight}
                  </span>
                </div>
              </CardContent>
